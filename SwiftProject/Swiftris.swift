...
//  SwiftProject
//
//  Created by william murphy on 11/3/15.
...
class Swiftris {
    ...
    init() {
        ...
        NumColumns = Int(floor(Double((screenSize.width - 100.0) / 20.0)))
        NumRows = Int(floor(Double((screenSize.height - 10.0) / 20.0)))
